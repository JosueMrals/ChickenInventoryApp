...
const AddProductModal = ({ visible, onClose, onAddProduct, cart }) => {
    ...
    const renderProductItem = ({ item }) => {
        ...
        return (
            ...
            >
                <Text style={[modalStyles.productName, isSelected && modalStyles.selectedProductName]}>{item.name}</Text>
...
const modalStyles = StyleSheet.create({
    ...
    list: { width: '100%' },
    productItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, borderBottomWidth: 1, borderBottomColor: '#eee', width: '100%' },
    ...
    closeButton: { backgroundColor: "#2196F3", borderRadius: 10, padding: 12, elevation: 2, marginTop: 15, width: '100%' },
